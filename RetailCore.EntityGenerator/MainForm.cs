...
namespace RetailCore.EntityGenerator
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeData()
        {
            ...
            this.tbxConnectionString.Text = new string("Data Source=2212VIKASS0000L\\MSSQLSERVER2019;Initial Catalog=DevelopmentDiary;Persist Security Info=True;User ID=sa;Password=Microsoft#1234;TrustServerCertificate=True");
